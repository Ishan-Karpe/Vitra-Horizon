    ...
    <View className="space-y-4">
            ...
            >
              <View className="items-center space-y-1">
                ...
                <Text className={`text-xs text-center ${
                  isSelected ? 'text-white opacity-90' : 'text-current opacity-70'
                }`}>
                  {option.description}
                </Text>
              </View>
      ...
      <View className="bg-gray-50 p-3 rounded-lg">
        <Text className="text-sm text-gray-600 text-center">
          ...
          {value === 'Medium' && 'Recommended for regular exercise and muscle maintenance'}
          {value === 'High' && 'Optimal for muscle building and intense training'}
        </Text>
      </View>
