...
export function Button({ 
  ...
  // Base button styles
  const baseStyles = 'rounded-lg font-semibold text-center transition-colors duration-200';
  ...
  const textClasses = variant === 'primary' || variant === 'secondary' ? 'text-white' : 
                     variant === 'outline' ? 'text-blue-600' : 'text-gray-700';
