...
export const UserDataProvider: React.FC<UserDataProviderProps> = ({
      ...
      try {
        ...
        if (storedData) {
          ...
          const cleanedData = {
            ...storedData,
            bodyFatPercentage:
              Math.round(storedData.bodyFatPercentage * 10) / 10,
          };
  ...
  const updateUserData = (
    fieldOrUpdates: keyof UserData | Partial<UserData>,
    value?: number | string,
  ) => {
    if (typeof fieldOrUpdates === "string" && value !== undefined) {
      ...
      const processedValue =
        field === "bodyFatPercentage" && typeof value === "number"
      ...
      if (
        "bodyFatPercentage" in processedUpdates &&
        typeof processedUpdates.bodyFatPercentage === "number"
      ) {
        processedUpdates.bodyFatPercentage =
          Math.round(processedUpdates.bodyFatPercentage * 10) / 10;
      }
      if (
        "targetBodyFat" in processedUpdates &&
        typeof processedUpdates.targetBodyFat === "number"
      ) {
        processedUpdates.targetBodyFat =
          Math.round(processedUpdates.targetBodyFat * 10) / 10;
      }
