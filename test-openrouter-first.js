...
async function testOpenRouterFirstConfiguration() {
  ...
  try {
    ...
    const predictionResponse = await fetch(
      "http://localhost:8087/api/predictions",
      {
        method: "POST",
    ...
    console.log(
      `   Body Fat: ${predictionData.currentBodyFat}% → ${predictionData.targetBodyFat}%`,
    );
    ...
    console.log(
      "   1. Make sure backend is running: node ai-backend-server.js",
    );
